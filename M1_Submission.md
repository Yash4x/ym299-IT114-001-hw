...
<tr><td> <em>Generated: </em> 9/17/2023 11:55:02 AM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT114-001-F23/it114-m1-gettingstarted/grade/ym299" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fym299%2F2023-09-17T15.35.46image.png.webp?alt=media&token=cf308493-f259-4136-8553-9a11287c343a"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing that WakaTime is installed with the correct API key and shows no<br>errors.<br></p>
</td></tr>
<tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fym299%2F2023-09-17T15.39.02image.png.webp?alt=media&token=1d21c156-c80d-4cb2-97c1-d897a94448b6"/></td></tr>
<tr><td> <em>Caption:</em> <p>Showing all the installed Java extensions.<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned how to use some useful git commands such as add, commit,<br>push, checkout, nano, cd, rm, and etc. Moreover, I learned how to resolve<br>merging conflicts between local and remote GitHub repositories. I also learned that git<br>add commands only works when a file already exists, meaning, from what I<br>understand, git cannot create new files, instead, you have to create it in<br>the local repo and then run the add cmnd.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned to resolve an issue I had when trying to clone repos<br>or pushing/ committing a change. When trying to use these commands even with<br>the correct SSH key setup, it seems the SSH agent does not run<br>sometimes, therefore, I regularly end up using eval &quot;$(ssh-agent -s)&quot; and ssh-add ~/.ssh/[keyname]<br>commands to resolve it.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Yash4x/IT114-001/pull/1">https://github.com/Yash4x/IT114-001/pull/1</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT114-001-F23/it114-m1-gettingstarted/grade/ym299" target="_blank">Grading</a></td></tr></table>
